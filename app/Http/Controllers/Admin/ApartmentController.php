...
use App\ViewModels\ApartmentView\ApartmentViewModel;
use App\ViewModels\HotelApartmentView\HotelApartmentViewModel;
...
class ApartmentController extends Controller
{
    ...
    public function __construct(HotelApartment $HotelApartment){
        ...
        $this->messageStore='Success Add Apartment';
        $this->messageUpdate='Update Apartment';
        $this->messageDelete='Success  Delete Apartment';
        $this->route='admin.apartment.index';
        $this->nameViewCrud='admin.apartment';
        $this->StoreAction=StoreHotelApartmentAction::class;
        $this->UpdateAction=UpdateHotelApartmentAction::class;
    }

    public function ViewModel($data=null): ApartmentViewModel
    {
       $ViewMode = new ApartmentViewModel($data);
       return $ViewMode;
    }

    public function index():View
    {
        $data = $this->Model::SearchApartment();
