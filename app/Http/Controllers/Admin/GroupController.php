...
class GroupController extends Controller
{
    ...
    public function __construct(Group $Group){
        $this->Model=$Group;
        $this->messageStore='Success Add Group';
        $this->messageUpdate='Update Group';
        $this->messageDelete='Success  Delete Group';
        $this->route='admin.group.index';
        $this->nameViewCrud='admin.group';
        $this->StoreAction=StoreGroupAction::class;
        $this->UpdateAction=UpdateGroupAction::class;
    }

    public function ViewModel($data=null): GroupViewModel
    {
       $ViewMode = new GroupViewModel($data);
       return $ViewMode;
    }
