...
@section('contentfrontend')
    ...
    <h4>  الإسم الاول :  {{$first_name}} </h4>
	<h4>الإسم الأخير  : {{$last_name}}   </h4>
	<h4> البريد الإليكتروني : {{$email}}</h4>
	<h4>رقم الهاتف : {{$phone}}</h4>
	<h4>يوم الميلاد : {{$day}}</h4>
	<h4>شهر الميلاد : {{$month}}</h4>
	<h4>سنة الميلاد : {{$year}}</h4>
	<h4>اسم المستخدم : {{$username}} </h4>
	<h4>كلمة المرور  : {{$password}}</h4>
	<hr>
	<h4>اسم المستخدم : {{$username2}}</h4>
	<h4>البريد الإليكتروني : {{$email}}</h4>
	<h4>رقم الهاتف : {{$phone2}}</h4>
	<h4>وسيلة الإتصال المفضلة : {{$contact_method}}</h4>
	<h4>وسيلة الدفع المفضلة : {{$payment_method}}</h4>
	<h4>اخبرنا عن رحلتك : {{$your_travel}}</h4>
