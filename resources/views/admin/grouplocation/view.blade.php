                                                ...
                                                <table id="example5" class="display table dataTable no-footer"
                                                    ...
                                                    <thead>
                                                        <tr style="background-color: #F0F4F9;">
                                                            <x-admin.table th1='#'
                                                                th2="{{ TranslationHelper::translate('Group') }}"
                                                                th3="{{ TranslationHelper::translate('Location') }}"
                                                                th4="{{ TranslationHelper::translate('Created at') }}"
                                                                th5="{{ TranslationHelper::translate('processes') }}">
                                                            </x-admin.table>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
