                                                    ...
                                                    <thead>
                                                        <tr style="background-color: #F0F4F9;">
                                                            <x-admin.table th1='#'
                                                                ...
                                                                th6="{{ TranslationHelper::translate('Type') }}"
                                                                th7="{{ TranslationHelper::translate('Stars') }}"
                                                                th8="{{ TranslationHelper::translate('Seats') }}"
                                                                th9="{{ TranslationHelper::translate('Price') }}"
                                                                th10="{{ TranslationHelper::translate('Sort') }}"
                                                                th11="{{ TranslationHelper::translate('Status') }}"
                                                                th12="{{ TranslationHelper::translate('Created at') }}"
                                                                th13="{{ TranslationHelper::translate('processes') }}">
                                                            </x-admin.table>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
