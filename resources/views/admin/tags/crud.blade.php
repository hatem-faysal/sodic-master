                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.input old="{{ 'name.'.$item->key }}"
                                        ...
                                        :value="$Tag->translate('name', $item->key)"></x-admin.form.input>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.text old="{{ 'description.'.$item->key }}"
                                        ...
                                        :value="$Tag->translate('description', $item->key)"></x-admin.form.text>
                                    <x-admin.form.label-end
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.input old="sort" :value="$Tag->sort" name="sort" type="number"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.state :foreach="App\Models\StaticConst::STATUS" :model="$Tag" name="status"></x-admin.form.state>
