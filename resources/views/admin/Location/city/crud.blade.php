                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.input old="{{ 'name.'.$item->key }}"
                                        ...
                                        :value="$City->translate('name', $item->key)"></x-admin.form.input>
                                ...
                                disabled="disabled"  :model="$City" :foreach="$Country" name="country_id" id="country_id"  nameselect="Country">
                                </x-admin.form.dropdown>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.state :foreach="App\Models\StaticConst::STATUS" :model="$City" name="status"></x-admin.form.state>
