                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.input old="{{ 'name.'.$item->key }}"
                                        ...
                                        :value="$Location->translate('name', $item->key)"></x-admin.form.input>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.text old="{{ 'description.'.$item->key }}"
                                        ...
                                        :value="$Location->translate('description', $item->key)"></x-admin.form.text>
                                    <x-admin.form.label-end
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.state :foreach="App\Models\Location::TYPE"  :model="$Location" name="type"></x-admin.form.state>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.input old="price" :value="$Location->price" name="price" type="number"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.input old="sort" :value="$Location->sort" name="sort" type="number"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.state :foreach="App\Models\StaticConst::STATUS" :model="$Location" name="status"></x-admin.form.state>
                                    <x-admin.form.label-end name="{{ TranslationHelper::translate('Please Choose State') }}"> </x-admin.form.label-end>
                                </div>

                                @livewire('location',
                                ['CityId'=>$Location->City->id ?? '','CountryId'=>$Location->Country->id ?? '','DistrictId'=>$Location->District->id ?? '','DistrictShow'=>'show'])
