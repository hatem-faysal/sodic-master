                                                ...
                                                <table id="example5" class="display table dataTable no-footer"
                                                    ...
                                                    <thead>
                                                        <tr style="background-color: #F0F4F9;">
                                                            <x-admin.table th1='#'
                                                                th2="{{ TranslationHelper::translate('Price') }}"
                                                                th3="{{ TranslationHelper::translate('Type') }}"
                                                                th4="{{ TranslationHelper::translate('City From') }}"
                                                                th5="{{ TranslationHelper::translate('City To') }}"
                                                                th6="{{ TranslationHelper::translate('Sort') }}"
                                                                th7="{{ TranslationHelper::translate('Status') }}"
                                                                th8="{{ TranslationHelper::translate('Created at') }}"
                                                                th9="{{ TranslationHelper::translate('processes') }}">
                                                            </x-admin.table>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
